package net.redchujelly.cluttered.world;
...
import net.redchujelly.cluttered.world.tree.decorator.WillowTreeDecorator;
import net.redchujelly.cluttered.world.tree.foliageplacer.*;
import net.redchujelly.cluttered.world.tree.trunkplacer.*;
...
public class ClutteredConfiguredFeatures {
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(Cluttered.MOD_ID, name));
    }
