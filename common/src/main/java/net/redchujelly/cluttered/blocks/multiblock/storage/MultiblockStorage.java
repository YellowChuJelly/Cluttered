package net.redchujelly.cluttered.blocks.multiblock.storage;
...
public class MultiblockStorage extends MultiblockPlacer implements EntityBlock {
    public MultiblockStorage(BlockBehaviour.Properties pProperties) {
        super(pProperties);
    }
    ...
    public @Nullable BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        ...
        return BlockEntityRegistration.TWO_ROWS_BE.get().create(blockPos, blockState);
    }
}
